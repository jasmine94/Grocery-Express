...
<html lang="en">
  ...
  <body>
    ...
    <nav>
        <ul>
            <li><a href="#section-1" class="icon-shop"><span>Beverages</span></a></li>
            <li><a href="#section-2" class="icon-cup"><span>Canned Goods</span></a></li>
            <li><a href="#section-3" class="icon-food"><span>Dairy</span></a></li>
            <li><a href="#section-4" class="icon-lab"><span>Instant Goods</span></a></li>
            <li><a href="#section-5" class="icon-truck"><span>Snacks</span></a></li>
        </ul>
    </nav>
    ...
    <div class="content">
        <section id="section-1">
            <div class="mediabox">
                <img src="assets/img/beverages/1.jpg" alt="img01" />
                <h3>Coke in Can</h3>
            ...
            <div class="mediabox">
                <img src="assets/img/beverages/2.jpg" alt="img02" />
                <h3>Gatorade Orange</h3>
                <p>Lotus root water spinach fennel kombu maize bamboo shoot green bean swiss chard seakale pumpkin onion chickpea gram corn pea.</p>
	<a class="cbp-vm-icon cbp-vm-add" href="#">Add to cart</a>           
		   </div>
            <div class="mediabox">
                <img src="assets/img/beverages/3.jpg" alt="img03" />
                <h3>MineShine Milk Tea</h3>
                <p>Nori grape silver beet broccoli kombu beet greens fava bean potato quandong celery. Bunya nuts black-eyed pea prairie turnip leek lentil turnip greens parsnip.</p>
	<a class="cbp-vm-icon cbp-vm-add" href="#">Add to cart</a>          
		  </div>
			 <div class="mediabox">
                <img src="assets/img/beverages/4.jpg" alt="img03" />
                <h3>Absolute Distilled Water</h3>
                <p>Nori grape silver beet broccoli kombu beet greens fava bean potato quandong celery. Bunya nuts black-eyed pea prairie turnip leek lentil turnip greens parsnip.</p>
            	<a class="cbp-vm-icon cbp-vm-add" href="#">Add to cart</a>
			</div>
			 <div class="mediabox">
                <img src="assets/img/beverages/8.jpg" alt="img03" />
                <h3>Gatorade Red</h3>
                <p>Nori grape silver beet broccoli kombu beet greens fava bean potato quandong celery. Bunya nuts black-eyed pea prairie turnip leek lentil turnip greens parsnip.</p>
            	<a class="cbp-vm-icon cbp-vm-add" href="#">Add to cart</a>
			</div>
			 <div class="mediabox">
                <img src="assets/img/beverages/6.jpg" alt="img03" />
                <h3>Gatorade Yellow</h3>
                <p>Nori grape silver beet broccoli kombu beet greens fava bean potato quandong celery. Bunya nuts black-eyed pea prairie turnip leek lentil turnip greens parsnip.</p>
            	<a class="cbp-vm-icon cbp-vm-add" href="#">Add to cart</a>
			</div>
        ...
        <section id="section-2">
            <div class="mediabox">
                <img src="assets/img/canned goods/1.jpg" alt="img04" />
                <h3>Spam</h3>
            ...
            <div class="mediabox">
                <img src="assets/img/canned goods/2.jpg" alt="img05" />
                <h3>Spam Hot and Spicy </h3>
            ...
            <div class="mediabox">
                <img src="assets/img/canned goods/3.jpg" alt="img06" />
                <h3>Spam with Cheese</h3>
	...
	<a class="cbp-vm-icon cbp-vm-add" href="#">Add to cart</a>           
        ...
        <section id="section-3">
            <div class="mediabox">
                <img src="assets/img/dairy/3.jpg" alt="img02" />
                <h3>Yogurt Drink</h3>
	...
	<a class="cbp-vm-icon cbp-vm-add" href="#">Add to cart</a>           
            ...
            <div class="mediabox">
                <img src="assets/img/dairy/4.jpg" alt="img01" />
                <h3>Chuckie</h3>
	...
	<a class="cbp-vm-icon cbp-vm-add" href="#">Add to cart</a>           
		    ...
		    <div class="mediabox">
                <img src="assets/img/dairy/5.jpg" alt="img01" />
                <h3>CowHead Lite</h3>
                <p>Pea horseradish azuki bean lettuce avocado asparagus okra. Kohlrabi radish okra azuki bean corn fava bean mustard tigernut wasabi tofu broccoli mixture soup.</p>
	<a class="cbp-vm-icon cbp-vm-add" href="#">Add to cart</a>           
		   </div>
        ...
        <section id="section-4">
            <div class="mediabox">
                <img src="assets/img/instant goods/1.jpg" alt="img03" />
                <h3>Lucky Me</h3>
                <p>Chickweed okra pea winter purslane coriander yarrow sweet pepper radish garlic brussels sprout groundnut summer purslane earthnut pea tomato spring onion azuki bean gourd. </p>
	<a class="cbp-vm-icon cbp-vm-add" href="#">Add to cart</a>           
		   </div>
            ...
            <div class="mediabox">
                <img src="assets/img/instant goods/2.jpg" alt="img04" />
                <h3>Lucky Me</h3>
                <p>Celery quandong swiss chard chicory earthnut pea potato. Salsify taro catsear garlic gram celery bitterleaf wattle seed collard greens nori. </p>
	<a class="cbp-vm-icon cbp-vm-add" href="#">Add to cart</a>           
		   </div>
        ...
        <section id="section-5">
            <div class="mediabox">
                <img src="assets/img/snacks/1.jpg" alt="img02" />
                <h3>Oreo</h3>
	...
	<a class="cbp-vm-icon cbp-vm-add" href="#">Add to cart</a>           
            ...
            <div class="mediabox">
                <img src="assets/img/snacks/2.jpg" alt="img06" />
                <h3>Chips Ahoy</h3>
            ...
            <div class="mediabox">
                <img src="assets/img/snacks/3.jpg" alt="img01" />
                <h3>Cadbury</h3>
